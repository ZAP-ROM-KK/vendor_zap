...
# Set all versions
ZAP_VERSION := ZAP-$(PRODUCT_VERSION_MAJOR)-$(ZAP_BUILD_TYPE)-$(shell date +%Y-%m-%d)
ZAP_MOD_VERSION := ZAP-$(ZAP_BUILD)-$(PRODUCT_VERSION_MAJOR)-$(ZAP_BUILD_TYPE)-$(shell date +%Y-%m-%d)
