...
# Set all versions
OSE_VERSION := OSE-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(OSE_BUILD_TYPE)$(OSE_POSTFIX)-$(shell date +%Y-%m-%d)
OSE_MOD_VERSION := OSE-$(OSE_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(OSE_BUILD_TYPE)$(OSE_POSTFIX)-$(shell date +%Y-%m-%d)
